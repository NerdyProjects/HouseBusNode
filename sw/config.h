...
#define CONFIG(X) \
  ...
  X(CONFIG_WALL_TEMPERATURE_FACTOR_BY_1024, 4, CONFIG_PARAM_INT), \
  X(CONFIG_FAN_ON_ABOVE_MILLI_RELATIVE_HUMIDITY, 4, CONFIG_PARAM_INT), \
  X(CONFIG_FAN_RUN_OUT_TIME_S, 4, CONFIG_PARAM_INT), \
  X(CONFIG_HUMIDITY_ALARM_FIRST_AFTER_S, 4, CONFIG_PARAM_INT), \
  X(CONFIG_HUMIDITY_ALARM_REPEAT_INTERVAL_S, 4, CONFIG_PARAM_INT), \
  ...
  X(CONFIG_BOILER_MAX_TEMPERATURE, 4, CONFIG_PARAM_INT), \
  X(CONFIG_BOILER_MIN_TEMPERATURE, 4, CONFIG_PARAM_INT), \
  X(CONFIG_BOILER_TARGET_TEMPERATURE, 4, CONFIG_PARAM_INT), \
  X(CONFIG_HEATER_DEVIATION_HYSTERESIS, 4, CONFIG_PARAM_INT), \
