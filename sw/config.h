...
#define CONFIG(X) \
  ...
  X(CONFIG_HAS_PUMP_CONTROL_OUTPUT_PIN, 4, CONFIG_PARAM_INT), \
  ...
  X(CONFIG_EVENTCOUNT_PORT, 4, CONFIG_PARAM_INT), \
  X(CONFIG_EVENTCOUNT_PIN, 4, CONFIG_PARAM_INT), \
  X(CONFIG_EVENTCOUNT_MIN_STABLE_MS, 4, CONFIG_PARAM_INT), \
