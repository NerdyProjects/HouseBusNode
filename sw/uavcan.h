...
#define HOMEAUTOMATION_WATER_REFILL_STATE_DATA_TYPE_ID              20002UL
#define HOMEAUTOMATION_WATER_REFILL_STATE_DATA_TYPE_SIGNATURE       0xeb27367f6a6bff88
#define HOMEAUTOMATION_WATER_REFILL_STATE_MESSAGE_SIZE              ((56+7)/8)
